...
const StatusPanel = ({
  ...
  const calculateSectionProgress = (questions, answers, section) => {
    const sectionQuestions = questions.filter((q) => q.section === section);
    const answered = sectionQuestions.filter((q) => answers[q.key]).length;
    return { answered, total: sectionQuestions.length };
  };

  return (
    <div className="sticky top-1/2 transform -translate-y-1/2 left-0 p-4">
      ...
      {questions.map((question, index) => (
        ...
        >
          ...
          <div className="flex items-center gap-4">
            <strong className="flex ">Your Answer:</strong>
...
const Home = () => {
  ...
  return (
    <div className="flex">
      ...
      />
      <div className="flex flex-col w-full max-w-[500px] p-4 mx-auto overflow-y-auto">
